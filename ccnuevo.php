                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header bg-primary">
                      <h3 class="modal-title" id="exampleModalLabel">Agregar Item</h3>
                          ...
                          <form action="">
                              <div class="form-group col-md-8">
                                  <label for="usuario">Nombre de Marca</label>
                                      <input class="form-control" type="text" id="marca" name="marca" placeholder="Ingrese nombre de Paciente" required>
                              </div>
                                <br><br><br>
                    </div>
                  </div>
