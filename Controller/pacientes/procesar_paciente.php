...
$telMed=$_POST["telMed"];
    ...
    $sql="Insert Into tbl_paciente values(NULL,'$nombre','$direccion','$telCasa','$telMovil','$fechaEx','$fechaNac','$estadoCivil','$ocupacion','$recomendado','$perResp','$dirPerResp','$medPer','$telMed','activo')";
