      ...
      <ul class="nav navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="height:50px;">
            <i class="fa fa-user fa-lg"></i>&nbsp; Usuario<?php //echo $_SESSION["usuario"]; ?>&nbsp;
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="productos.php"><i class="fa fa-circle-o"></i> Registro</a></li>
          <li><a href="categorias.php"><i class="fa fa-circle-o"></i> Listado</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="compra.php"><i class="fa fa-circle-o"></i> Crear Cita</a></li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="calcular.php"><i class="fa fa-circle-o"></i> Pintura</a></li>
          <li><a href="cliente.php"><i class="fa fa-circle-o"></i> Clientes</a></li>
          <li><a href="rventas.php"><i class="fa fa-circle-o"></i> Listado de ventas</a></li>
        </ul>
      </li>
