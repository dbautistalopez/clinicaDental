...
if (isset($_POST['from'])) 
{
    ...
    if ($_POST['from']!="" AND $_POST['to']!="") 
    {
        ...
        // Paciente
        $paciente = evaluar($_POST['paciente']);

        // insertamos el evento
        $query="INSERT INTO agenda VALUES(null,'$titulo','$body','','$clase','$inicio','$final','$inicio_normal','$final_normal','$pacientes')";
...
<body>
    ...
    <div class="container col-md-12" style="padding:0 8% 0 8%;">
        <div class="row">
